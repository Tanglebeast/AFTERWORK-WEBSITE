    ...
    $(document).ready(function () {
        ...
        if (loadMoreButton.length) {
            loadMoreButton.on('click', function (e) {
                e.preventDefault();
                console.log('Load More Button clicked!'); // Debug-Ausgabe zur Überprüfung
                const hiddenGallery = $('#hidden-gallery');
                if (hiddenGallery.length) {
                    hiddenGallery.css('display', 'flex'); // Zeigt die versteckten Inhalte an
                    loadMoreButton.hide(); // Versteckt den Button nach dem Laden
                } else {
                    console.warn('Hidden gallery not found!');
                }
            });
        } else {
